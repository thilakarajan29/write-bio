...
import image1 from './1000_F_64672736_U5kpdGs9keUll8CRQ3p3YaEv2M6qkVY5.jpg'
  ...
  return (
    <div className="App-bio">
      <nav className="navbar-bio">
        <h1>LegalPulse</h1>
        <img src={image1} alt="profile" className="profile-img-bio" />
      </nav>
      ...
      <nav className="navbar-bottom-bio">
